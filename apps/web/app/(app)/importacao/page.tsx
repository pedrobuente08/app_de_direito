      ...
      <details className="rounded-[var(--radius-md)] border border-[var(--color-border-default)] bg-[var(--color-bg-surface)] p-4">
        ...
        <div className="mt-4 space-y-3">
          <p className="text-sm text-[var(--color-text-secondary)]">
            Cole um CSV com a primeira linha sendo o cabeçalho. Campos obrigatórios:{' '}
            <code className="rounded bg-[var(--color-bg-subtle)] px-1 font-mono text-xs">numero</code> e{' '}
            <code className="rounded bg-[var(--color-bg-subtle)] px-1 font-mono text-xs">sistema</code>.
          </p>
          <details className="text-xs">
            <summary className="cursor-pointer text-[var(--color-brand)] hover:underline">Ver exemplo de CSV</summary>
            <pre className="mt-2 overflow-x-auto rounded-[var(--radius-sm)] bg-[var(--color-bg-subtle)] p-3 text-[var(--color-text-secondary)]">{CSV_EXEMPLO}</pre>
          </details>
          ...
          {resultado && (
            <div className="space-y-4 rounded-[var(--radius-md)] border border-[var(--color-border-default)] bg-[var(--color-bg-muted)] p-4">
              <div className="flex gap-6">
                ...
                <div className="text-center">
                  <p
                    className={`text-2xl font-bold ${resultado.erros.length > 0 ? 'text-[var(--urgencia-vencida-text)]' : 'text-[var(--color-text-secondary)]'}`}
                  >
              ...
              {resultado.erros.length > 0 && (
                <div>
                  <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-[var(--urgencia-vencida-text)]">
                    Linhas com erro
                  </p>
                  <div className="max-h-40 space-y-1 overflow-y-auto rounded-[var(--radius-sm)] bg-[var(--urgencia-vencida-bg)] p-3">
